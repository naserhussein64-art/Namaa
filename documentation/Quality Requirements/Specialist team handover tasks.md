# Namaa Specialist Team Handover Tasks
...
If these inputs are incomplete, the specialist team must record the gap and request a decision rather than inventing a project fact.
...
- adult learning and training of teachers or facilitators;
- disability inclusion, accessibility, gender, and differentiated support;
- Syrian educational and social context, Arabic language, and cultural review;
- safeguarding and professional boundaries;
- monitoring, evaluation, and ethical evidence design; and
- data protection, digital delivery, or AI where the proposed design triggers those areas.
...
The team must define the programme purpose, theory of change, intended proximal outcomes, content scope, exclusions, sequence, duration, delivery format, group assumptions, and conditions under which the design would not be suitable. Longer-term life outcomes may remain aspirations but must not be presented as effects of an early pilot.
...
### ST-04 — Design inclusion and accessibility

The team must identify likely barriers and necessary accommodations for the selected learners, including children with disabilities, children with long learning interruptions, out-of-school children, returnees, and girls where relevant to the programme. It must define accessible formats, differentiated participation and assessment options, facilitator guidance, and the specialist support that cannot be provided through Namaa.
...
### ST-08 — Assess technology and AI options

Technology or AI should be proposed only for a defined problem. The team must compare it with a workable non-AI option and document expected value, source material, human review, accessibility, data needs, failure modes, correction, and an offline or low-connectivity fallback. AI must not diagnose children, make safeguarding decisions, determine educational futures, or replace accountable professional judgement.

### ST-09 — Prepare the controlled programme package

All approved materials must have an owner, version, date, source record, review status, permitted use, language status, and change history. Unresolved issues, assumptions, risks, dependencies, and dissenting specialist views must remain visible.
...
5. learning objectives, curriculum or module plan, and delivery sequence;
6. controlled Arabic learner and facilitator materials;
7. inclusion, accessibility, and accommodation plan;
8. professional-boundary and referral-trigger matrix;
9. safeguarding integration and activity-level risk recommendations;
10. trainer and facilitator competence profile;
11. facilitator-training, practice, assessment, supervision, and refresher package;
12. programme-specific MEL matrix, instruments, decision rules, and evidence limits;
13. technology and AI assessment, including the non-AI alternative;
14. implementation assumptions, resource needs, dependencies, and contingency requirements;
15. consolidated risk register and unresolved questions for Namaa leadership; and
16. a signed or otherwise attributable review record identifying what each specialist approved, conditionally approved, or did not approve.

## 7. Matters not assigned solely to the specialist team

The following remain organisational or implementation responsibilities. Specialists may advise, but they do not approve them alone:

- formal adoption of YISA policies and appointment of accountable roles;
- selection, legal assessment, due diligence, and contracting of a Syrian host or partner;
- verification of Syrian permissions, mandatory reporting duties, and local authority requirements;
- establishment and testing of local safeguarding, emergency, health, disability, psychosocial, and protection referral pathways;
- German and Syrian legal, employment, volunteer, insurance, intellectual-property, tax, sanctions, banking, and funding checks;
- controller roles, lawful basis, international data transfers, system security, retention, and deletion;
- commissioning any required independent ethics review or specialist safeguarding investigation route;
- recruitment of children, caregiver permission, child assent, and operational pilot approval;
- fundraising eligibility, financial commitments, public claims, and the decision to launch, pause, stop, repeat, or scale.

These dependencies must be tracked alongside the specialist work because the programme cannot pass later quality gates without them.

## 8. Acceptance and completion boundary

The work package is ready for Namaa review only when the required outputs are complete, internally consistent, source-traceable, versioned, context-reviewed, accessible by design, and accompanied by explicit approvals, conditions, limitations, and open questions.

Namaa project leadership decides whether the package passes NQ-G1. Passing NQ-G1 means only that a defined programme version may become the basis for trainer preparation and later local-readiness work. It does not authorise adult training, child participation, collection of real child data, programme delivery, public effectiveness claims, replication, or scale.
...
- Programme package and training package: **Not developed**.
- Specialist approvals: **Not obtained**.
- NQ-G1 programme-release decision: **Not reached**.
